...
export const DEPARTAMENTOS_COLOMBIA: Departamento[] = [
  ...
  },
  {
    ...
    municipios: [
      ...
      { codigo: "73055", nombre: "Armero Guayabal" },
 ...
 */
export function buscarDepartamento(codigo: string): Departamento | undefined {
  return DEPARTAMENTOS_COLOMBIA.find((d) => d.codigo === codigo);
}

/**
 * Buscar municipio por código en un departamento
 */
export function buscarMunicipio(codigoDepartamento: string, codigoMunicipio: string): Municipio | undefined {
  const departamento = buscarDepartamento(codigoDepartamento);
  return departamento?.municipios.find((m) => m.codigo === codigoMunicipio);
}

/**
 * Obtener todos los municipios de un departamento
 */
export function obtenerMunicipiosPorDepartamento(codigoDepartamento: string): Municipio[] {
  const departamento = buscarDepartamento(codigoDepartamento);

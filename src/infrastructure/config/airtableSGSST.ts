...
export const airtableSGSSTConfig = {
  ...
  copasstActasFields: {
    ...
    CAPACITACIONES_MANUALES:     process.env.COPASST_ACTAS_CAPACITACIONES_MANUALES_FIELD!,
  ...
  // ══════════════════════════════════════════════════════════
  // MEDICINA LABORAL (med_*)
  // Resolución 2346/2007 · Resolución 1918/2009 · Decreto 1072/2015
  // ══════════════════════════════════════════════════════════

  // ── Tabla "med_examenes" (exámenes ocupacionales) ─────────
  medExamenesTableId: process.env.AIRTABLE_MED_EXAMENES_TABLE_ID!,
  medExamenesFields: {
    CONSECUTIVO:         process.env.AIRTABLE_MED_EXM_CONSECUTIVO!,
    FECHA_EXAMEN:        process.env.AIRTABLE_MED_EXM_FECHA_EXAMEN!,
    TIPO_EXAMEN:         process.env.AIRTABLE_MED_EXM_TIPO_EXAMEN!,
    ID_EMPLEADO_CORE:    process.env.AIRTABLE_MED_EXM_ID_EMPLEADO_CORE!,
    NOMBRE_EMPLEADO:     process.env.AIRTABLE_MED_EXM_NOMBRE_EMPLEADO!,
    NUMERO_DOCUMENTO:    process.env.AIRTABLE_MED_EXM_NUMERO_DOCUMENTO!,
    CARGO:               process.env.AIRTABLE_MED_EXM_CARGO!,
    IPS_ENTIDAD:         process.env.AIRTABLE_MED_EXM_IPS_ENTIDAD!,
    CONCEPTO_APTITUD:    process.env.AIRTABLE_MED_EXM_CONCEPTO_APTITUD!,
    RESTRICCIONES:       process.env.AIRTABLE_MED_EXM_RESTRICCIONES!,
    RECOMENDACIONES:     process.env.AIRTABLE_MED_EXM_RECOMENDACIONES!,
    ESTADO:              process.env.AIRTABLE_MED_EXM_ESTADO!,
    FECHA_PROGRAMADA:    process.env.AIRTABLE_MED_EXM_FECHA_PROGRAMADA!,
    DOCUMENTO_URL:       process.env.AIRTABLE_MED_EXM_DOCUMENTO_URL!,
    OBSERVACIONES:       process.env.AIRTABLE_MED_EXM_OBSERVACIONES!,
    ACTIVO:              process.env.AIRTABLE_MED_EXM_ACTIVO!,
    CREATED_AT:          process.env.AIRTABLE_MED_EXM_CREATED_AT!,
    UPDATED_AT:          process.env.AIRTABLE_MED_EXM_UPDATED_AT!,
  },

  // ── Tabla "med_seguimientos" (seguimientos médicos) ───────
  medSeguimientosTableId: process.env.AIRTABLE_MED_SEGUIMIENTOS_TABLE_ID!,
  medSeguimientosFields: {
    CONSECUTIVO:          process.env.AIRTABLE_MED_SEG_CONSECUTIVO!,
    FECHA_SEGUIMIENTO:    process.env.AIRTABLE_MED_SEG_FECHA_SEGUIMIENTO!,
    TIPO_SEGUIMIENTO:     process.env.AIRTABLE_MED_SEG_TIPO_SEGUIMIENTO!,
    ID_EMPLEADO_CORE:     process.env.AIRTABLE_MED_SEG_ID_EMPLEADO_CORE!,
    NOMBRE_EMPLEADO:      process.env.AIRTABLE_MED_SEG_NOMBRE_EMPLEADO!,
    NUMERO_DOCUMENTO:     process.env.AIRTABLE_MED_SEG_NUMERO_DOCUMENTO!,
    CARGO:                process.env.AIRTABLE_MED_SEG_CARGO!,
    DIAGNOSTICO:          process.env.AIRTABLE_MED_SEG_DIAGNOSTICO!,
    ACCIONES_REALIZADAS:  process.env.AIRTABLE_MED_SEG_ACCIONES_REALIZADAS!,
    RECOMENDACIONES:      process.env.AIRTABLE_MED_SEG_RECOMENDACIONES!,
    PROXIMA_CITA:         process.env.AIRTABLE_MED_SEG_PROXIMA_CITA!,
    DOCUMENTO_URL:        process.env.AIRTABLE_MED_SEG_DOCUMENTO_URL!,
    OBSERVACIONES:        process.env.AIRTABLE_MED_SEG_OBSERVACIONES!,
    ACTIVO:               process.env.AIRTABLE_MED_SEG_ACTIVO!,
    CREATED_AT:           process.env.AIRTABLE_MED_SEG_CREATED_AT!,
    UPDATED_AT:           process.env.AIRTABLE_MED_SEG_UPDATED_AT!,
  },

  // ── Tabla "med_incapacidades" (incapacidades médicas) ─────
  medIncapacidadesTableId: process.env.AIRTABLE_MED_INCAPACIDADES_TABLE_ID!,
  medIncapacidadesFields: {
    CONSECUTIVO:                process.env.AIRTABLE_MED_INC_CONSECUTIVO!,
    TIPO:                       process.env.AIRTABLE_MED_INC_TIPO!,
    ID_EMPLEADO_CORE:           process.env.AIRTABLE_MED_INC_ID_EMPLEADO_CORE!,
    NOMBRE_EMPLEADO:            process.env.AIRTABLE_MED_INC_NOMBRE_EMPLEADO!,
    NUMERO_DOCUMENTO:           process.env.AIRTABLE_MED_INC_NUMERO_DOCUMENTO!,
    CARGO:                      process.env.AIRTABLE_MED_INC_CARGO!,
    DIAGNOSTICO:                process.env.AIRTABLE_MED_INC_DIAGNOSTICO!,
    FECHA_INICIO:               process.env.AIRTABLE_MED_INC_FECHA_INICIO!,
    FECHA_FIN:                  process.env.AIRTABLE_MED_INC_FECHA_FIN!,
    DIAS_INCAPACIDAD:           process.env.AIRTABLE_MED_INC_DIAS_INCAPACIDAD!,
    ENTIDAD_EMISORA:            process.env.AIRTABLE_MED_INC_ENTIDAD_EMISORA!,
    NUMERO_INCAPACIDAD:         process.env.AIRTABLE_MED_INC_NUMERO_INCAPACIDAD!,
    PRORROGA:                   process.env.AIRTABLE_MED_INC_PRORROGA!,
    INCAPACIDAD_ORIGEN_LINK:    process.env.AIRTABLE_MED_INC_INCAPACIDAD_ORIGEN_LINK!,
    DOCUMENTO_URL:              process.env.AIRTABLE_MED_INC_DOCUMENTO_URL!,
    OBSERVACIONES:              process.env.AIRTABLE_MED_INC_OBSERVACIONES!,
    ACTIVO:                     process.env.AIRTABLE_MED_INC_ACTIVO!,
    CREATED_AT:                 process.env.AIRTABLE_MED_INC_CREATED_AT!,
    UPDATED_AT:                 process.env.AIRTABLE_MED_INC_UPDATED_AT!,
  },

  // ── Tabla "med_reubicaciones" (reubicaciones laborales) ───
  medReubicacionesTableId: process.env.AIRTABLE_MED_REUBICACIONES_TABLE_ID!,
  medReubicacionesFields: {
    CONSECUTIVO:         process.env.AIRTABLE_MED_REU_CONSECUTIVO!,
    TIPO:                process.env.AIRTABLE_MED_REU_TIPO!,
    ID_EMPLEADO_CORE:    process.env.AIRTABLE_MED_REU_ID_EMPLEADO_CORE!,
    NOMBRE_EMPLEADO:     process.env.AIRTABLE_MED_REU_NOMBRE_EMPLEADO!,
    NUMERO_DOCUMENTO:    process.env.AIRTABLE_MED_REU_NUMERO_DOCUMENTO!,
    CARGO_ORIGEN:        process.env.AIRTABLE_MED_REU_CARGO_ORIGEN!,
    CARGO_DESTINO:       process.env.AIRTABLE_MED_REU_CARGO_DESTINO!,
    FECHA_INICIO:        process.env.AIRTABLE_MED_REU_FECHA_INICIO!,
    FECHA_FIN_ESTIMADA:  process.env.AIRTABLE_MED_REU_FECHA_FIN_ESTIMADA!,
    FECHA_CIERRE:        process.env.AIRTABLE_MED_REU_FECHA_CIERRE!,
    MOTIVO:              process.env.AIRTABLE_MED_REU_MOTIVO!,
    RESTRICCIONES:       process.env.AIRTABLE_MED_REU_RESTRICCIONES!,
    ESTADO:              process.env.AIRTABLE_MED_REU_ESTADO!,
    REHABILITADO:        process.env.AIRTABLE_MED_REU_REHABILITADO!,
    DOCUMENTO_URL:       process.env.AIRTABLE_MED_REU_DOCUMENTO_URL!,
    OBSERVACIONES:       process.env.AIRTABLE_MED_REU_OBSERVACIONES!,
    ACTIVO:              process.env.AIRTABLE_MED_REU_ACTIVO!,
    CREATED_AT:          process.env.AIRTABLE_MED_REU_CREATED_AT!,
    UPDATED_AT:          process.env.AIRTABLE_MED_REU_UPDATED_AT!,
  },

  // ── Tabla "med_enfermedades_laborales" ────────────────────
  medEnfermedadesLaboralesTableId: process.env.AIRTABLE_MED_ENFERMEDADES_LABORALES_TABLE_ID!,
  medEnfermedadesLaboralesFields: {
    CONSECUTIVO:            process.env.AIRTABLE_MED_EL_CONSECUTIVO!,
    ID_EMPLEADO_CORE:       process.env.AIRTABLE_MED_EL_ID_EMPLEADO_CORE!,
    NOMBRE_EMPLEADO:        process.env.AIRTABLE_MED_EL_NOMBRE_EMPLEADO!,
    NUMERO_DOCUMENTO:       process.env.AIRTABLE_MED_EL_NUMERO_DOCUMENTO!,
    CARGO:                  process.env.AIRTABLE_MED_EL_CARGO!,
    DIAGNOSTICO:            process.env.AIRTABLE_MED_EL_DIAGNOSTICO!,
    FECHA_DIAGNOSTICO:      process.env.AIRTABLE_MED_EL_FECHA_DIAGNOSTICO!,
    FECHA_INICIO_SINTOMAS:  process.env.AIRTABLE_MED_EL_FECHA_INICIO_SINTOMAS!,
    ESTADO:                 process.env.AIRTABLE_MED_EL_ESTADO!,
    ENTIDAD_CALIFICADORA:   process.env.AIRTABLE_MED_EL_ENTIDAD_CALIFICADORA!,
    FECHA_CALIFICACION:     process.env.AIRTABLE_MED_EL_FECHA_CALIFICACION!,
    PCL:                    process.env.AIRTABLE_MED_EL_PCL!,
    FECHA_ESTRUCTURACION:   process.env.AIRTABLE_MED_EL_FECHA_ESTRUCTURACION!,
    DOCUMENTO_URL:          process.env.AIRTABLE_MED_EL_DOCUMENTO_URL!,
    OBSERVACIONES:          process.env.AIRTABLE_MED_EL_OBSERVACIONES!,
    ACTIVO:                 process.env.AIRTABLE_MED_EL_ACTIVO!,
    CREATED_AT:             process.env.AIRTABLE_MED_EL_CREATED_AT!,
    UPDATED_AT:             process.env.AIRTABLE_MED_EL_UPDATED_AT!,
  },
};

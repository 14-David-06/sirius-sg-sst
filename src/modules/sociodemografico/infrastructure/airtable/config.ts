...
export const SOCIO_CONFIG = {
  ...
  campanas: {
    ...
    fields: {
      ...
      AÑO: process.env.AIRTABLE_SOCIO_CAMPANAS_AÑO!,
      ...
      ID_CAMPANA: process.env.AIRTABLE_SOCIO_CAMPANAS_ID_CAMPANA!,
    },
  },
  ...
  respuestas: {
    ...
    fields: {
      ...
      MUNICIPIO_RESIDENCIA: process.env.AIRTABLE_SOCIO_RESP_MUNICIPIO_RESIDENCIA!,
      ESTRATO: process.env.AIRTABLE_SOCIO_RESP_ESTRATO!,
      TIPO_VIVIENDA: process.env.AIRTABLE_SOCIO_RESP_TIPO_VIVIENDA!,
      PERSONAS_A_CARGO: process.env.AIRTABLE_SOCIO_RESP_PERSONAS_A_CARGO!,
      ESCOLARIDAD: process.env.AIRTABLE_SOCIO_RESP_ESCOLARIDAD!,
      ESTUDIANDO_ACTUALMENTE: process.env.AIRTABLE_SOCIO_RESP_ESTUDIANDO_ACTUALMENTE!,
      ...
      FECHA_INGRESO_SIRIUS: process.env.AIRTABLE_SOCIO_RESP_FECHA_INGRESO_SIRIUS!,
      TURNO_TRABAJO: process.env.AIRTABLE_SOCIO_RESP_TURNO_TRABAJO!,
      ...
      CUAL_ENFERMEDAD_CRONICA: process.env.AIRTABLE_SOCIO_RESP_CUAL_ENFERMEDAD_CRONICA!,
      ...
      ACCIDENTES_TRABAJO_PREVIOS: process.env.AIRTABLE_SOCIO_RESP_ACCIDENTES_TRABAJO_PREVIOS!,
      ENFERMEDAD_LABORAL_PREVIA: process.env.AIRTABLE_SOCIO_RESP_ENFERMEDAD_LABORAL_PREVIA!,
      ...
      MEDIO_TRANSPORTE: process.env.AIRTABLE_SOCIO_RESP_MEDIO_TRANSPORTE!,
      TIEMPO_DESPLAZAMIENTO: process.env.AIRTABLE_SOCIO_RESP_TIEMPO_DESPLAZAMIENTO!,
      ACEPTA_POLITICA_DATOS: process.env.AIRTABLE_SOCIO_RESP_ACEPTA_POLITICA_DATOS!,

...
export const SOCIO_CONFIG = {
  ...
  respuestas: {
    ...
    fields: {
      ...
      FIRMA: process.env.AIRTABLE_SOCIO_RESP_FIRMA!,
      // Nuevos campos de descripción
      DESC_OTRO_EMPLEO: process.env.AIRTABLE_SOCIO_RESP_DESC_OTRO_EMPLEO || "",
      DESC_TRATAMIENTO: process.env.AIRTABLE_SOCIO_RESP_DESC_TRATAMIENTO || "",
      DESC_ACCIDENTES: process.env.AIRTABLE_SOCIO_RESP_DESC_ACCIDENTES || "",
      DESC_ENF_LABORAL: process.env.AIRTABLE_SOCIO_RESP_DESC_ENF_LABORAL || "",
      DESC_OTRO_TIEMPO_LIBRE: process.env.AIRTABLE_SOCIO_RESP_DESC_OTRO_TIEMPO_LIBRE || "",
    },
  },

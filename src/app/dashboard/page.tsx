...
const modulesByPhase: Record<Phase, Module[]> = {
  ...
  P: [
    ...
    },
    {
      ...
      description: "Caracterización demográfica de trabajadores con encuesta digital y análisis estadístico.",
      icon: I.userGroup,
      color: "bg-violet-500/15 text-violet-300",
      href: "/dashboard/sociodemografico",
      status: "active",
      estandar: "Estándar 1.2.1",
    },
  ],
  // ════════════════════ H · HACER ══════════════════════
  H: [

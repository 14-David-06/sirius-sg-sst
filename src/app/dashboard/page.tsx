...
const modules = [
  ...
  },
  {
    ...
    description: "Registro y seguimiento de inspecciones de condición de EPP.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    title: "Inspecciones Equipos",
    description: "Extintores, botiquines, camillas y kits de derrames por área.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
